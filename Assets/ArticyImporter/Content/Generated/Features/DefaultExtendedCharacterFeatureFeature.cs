...
namespace Articy.A_Coven_Of_Cards.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.A_Coven_Of_Cards.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.A_Coven_Of_Cards.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
        ...
        {
            Articy.A_Coven_Of_Cards.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.A_Coven_Of_Cards.Features.DefaultExtendedCharacterFeatureFeature();
