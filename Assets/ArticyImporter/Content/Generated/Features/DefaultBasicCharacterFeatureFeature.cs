...
namespace Articy.A_Coven_Of_Cards.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.A_Coven_Of_Cards.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.A_Coven_Of_Cards.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
        ...
        {
            Articy.A_Coven_Of_Cards.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.A_Coven_Of_Cards.Features.DefaultBasicCharacterFeatureFeature();
